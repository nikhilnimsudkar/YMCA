...
@Lazy(true)
@Scope("prototype")
public class GenericDbToSCJobScheduler extends GenericJobScheduler implements InitializingBean {
	...
	public void loadJob() throws Exception {
		...
		job = customJobBuilderFactory.buildDbToScJob(jobSchedulerMetadata, job);
