...
function backToMembership(){
	window.location.href = "currentmembership";
}
...
<div id="UpdateDraftCycleDiv" class="k-block" style="background-color: #FFFFFF; margin-left: 10px; padding-top: 10px; padding-left: 10px; width: 730px;">
	
	<div style="padding:10px 0px 10px 0px; margin-top:10px">
			...
			<div  align="center">
					...
					<span class="k-button" id="backToRecentDonations" onclick="backToMembership()" style="margin-left: 5px;">Back</span>
			</div>
			<br><br>
		</div>
</div>
