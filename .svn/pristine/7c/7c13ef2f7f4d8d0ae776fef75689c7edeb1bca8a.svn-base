<div id="selectInServiceDaysHead" style="width: 890px;; padding: 12px;">
	...
	<div>
		...
		<span id="pkgPriceInfo">(Package price <span id="memberpackagePrice">$00.00</span>/ <span id="nonmemberpackagePrice">$00.00</span> is applicable if there is capacity on all the days and all the days are selected)</span>
		<br><br><span class="alertNotice">In-Service Sign up price will be divided by <span id="inserviceMonthsText" style="font-weight:bold;"># of child-care</span> months.</span>
	</div>
	<div style="clear: both;"></div> 
	<div id="selectInServiceDays" style="margin: 20px 20px 30px;  min-height: 220px;">
		<div>
			<span style="font-size: 14px; font-weight:bold;"><span class="tortoise">Select</span>&nbsp;&nbsp;/&nbsp;&nbsp;<span class="tortoise">Unselect</span></span>
		</div>
