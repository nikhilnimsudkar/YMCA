...
public class BaseService {
	...
	@Resource
	protected SetpUpFeeDao setpUpFeeDao ;
	...
	protected List<String> daysArr = Arrays.asList("Sun","Mon","Tues","Wed","Thurs","Fri","Sat");
	...
	public synchronized void updateCapacityforDays(ItemDetail itemDetail, String dayId) {
		if(itemDetail!=null && dayId!=null){
			...
			if(itemDetailDays!=null){
				if(itemDetailDays.getStopConfirmedSignUps() == null || itemDetailDays.getStopConfirmedSignUps().equalsIgnoreCase("No")){
