						...
						<div id="tabstrip4" class="k-block"	style="background-color: #FFFFFF; margin-left: -71px; padding: 10px;   width: 600px;">
							...
							<table border="0">
								...
								<c:if test="${signup.draftCycle != null}">
									<tr>
									<td><span style="font-weight: normal;">Draft Cycle</span></td>
									<td> : </td>
									<td><span>${ signup.draftCycle }</span></td>
								</tr>
								</c:if>
