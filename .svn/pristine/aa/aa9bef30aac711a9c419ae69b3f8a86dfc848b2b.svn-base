...
<div>
					...
					<span class="head" style="width:100px;padding-top:50px;color:#eb8120;font-weight:bold;">WELCOME AGENT NAME.!</span>
	...
	<div id="tabstrip5" class="k-block" style="border-color:#fcaf17;">
      ...
      <c:otherwise> --%>
      <br>
      <span class="head" style="width:100px; padding-top:5px;padding-left:5px;">AGENET DETAILS</span></br>	
