...
<script id="Cancel-ErrorBox" type="text/x-kendo-template">     
	<p class="error-message-p">Please contact Y-Agent to cancel the Donation</p>
	
    <div class="confirmbutton" align="center"><button class="confirm-Cancel-Error k-button" style=" width: 35%;">Ok</button>  
</script>
...
<script>
	...
	function showCancelError(){
		...
		kendoWindow.data("kendoWindow")
		 .content($("#Cancel-ErrorBox").html())
		 .center().open();

		kendoWindow
		.find(".confirm-Cancel-Error")
		.click(function() {
			if ($(this).hasClass("confirm-Cancel-Error")) {         		
				kendoWindow.data("kendoWindow").close();
			}
		})
		.end();		
