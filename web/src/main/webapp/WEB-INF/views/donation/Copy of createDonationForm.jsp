			...
			<div>
				  ...
				  <table border="0" class="" id="billingSetUpTableId" width="50%">
				  		...
				  		<tr>
				  			...
				  			<td><input type="text" placeholder="Billing Start Date" name="billingStartDate" id="billingStartDate" value="" style="margin: 0px; width : 240px;" /></td>				  			
				  		</tr>
				  		<tr>
				  			<td>Number of Installments</td>
				  			<td>
				  				<select id="numberOfInstallments" name="numberOfInstallments" style="width : 100%;">  					  		
							  	</select>
				  			</td>			  			
				  		</tr>
				  		<tr>
				  		...
				  		<tr>
				  			...
				  			<td>
				  				<select id="billingOption" name="billingOption" style="width : 100%;">
				  					<option value="Automatic">EFT Billing</option>
				  		...
				  		<tr>
				  			<td>Down Payment</td>
				  			<td><input type="text" placeholder="Down Payment" name="downPayment" id="downPayment" value="" style=""/></td>			  			
				  		</tr>
				  		<tr>
...
<script>
	...
	$(document).ready(function() {
		...
		$("#generateBillingSetup").click(function(){
			...
			$(".billingSetUpBillDate").kendoDatePicker({
				format: "MM/dd/yyyy",				
				min: dateToday
			}); 
	...
	function getBillingSetupHtml(){
		...
		for(var i = 1; i<= noOfInstallment; i++){	
			...
			billingSetupHtml += '<td style="width : 43%"><input type="text" placeholder="Billing Start Date" name="billingDate" value="'+tempDate+'" class="billingSetUpBillDate" style="margin: 0px; width : 200px;"/></td>';
			if(i == 1){
				billingSetupHtml += '<td style="width : 43%"><input type="text" placeholder="Billing Amount" name="billingStartDate" id="billingStartDate" value="'+adjustAmt+'" style="margin: 0px; width : 240px;" /></td>';
			}else{
				billingSetupHtml += '<td style="width : 43%"><input type="text" placeholder="Billing Amount" name="billingStartDate" id="billingStartDate" value="'+intervalAmt+'" style="margin: 0px; width : 240px;" /></td>';	
			}						  			
			billingSetupHtml += '</tr>';
			if(billingFreq){
