...
<script>
	...
	function getContactHistory(contacts){
		...
		console.log("  getContactHistory() ... contacts.length  "+contacts.length);
		if(contacts && contacts.length > 0){
			
			
			/* var values = $('input[name="contactId"]').map(function() {
		        return this.value
		    }).get()
			
			console.log("  existing contacts :::  "+values); */
					...
					if(data && data.length > 0){
						var obj = jQuery.parseJSON(data);
					  	 $.each(obj, function(i,contact) {
					  		...
					  		console.log(" contact.healthHistoryId ::: "+contact.healthHistoryId);
			...
			//console.log("  getContactHistory() ... 188 ");
