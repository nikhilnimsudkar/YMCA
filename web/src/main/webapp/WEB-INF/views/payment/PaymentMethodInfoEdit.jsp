			...
			<div id="paymentMethodEdit" class="k-block" style="margin-top: 20px; padding: 10px; height: 350px;" >
        		...
        		<div id="purchase_info" >
					...
					<!-- 	<div class="addcarddiv" style="width: 100%;">
							...
							<div id="addcard" style="margin-top:10px; margin-bottom:10px; display:none; float: left; ">
								...
								<div class="addcarddiv">
									...
									<div>
										...
										<span>
											<select id="addCardExpirationYearSelect" name="addCardExpirationYearSelect" tabIndex="4" style="width:70px; font-weight: normal;">																
											</select>
										</span>
									</div>
								</div>
				        ...
				        <div id="remove_card_payment_method_signup_list" align="center" style="width:500px; margin-top:25px; margin-bottom:10px; display:none; background-color:#FFFFFF;"> <!-- class="k-block" -->
					        <table cellpadding="0" cellspacing="0" rules="none" style="padding-left:4px;padding-top:4px; width: 500px;" id="remove_card_payment_method_signup_list_table">
					        	<tr align="left" style="height: 30px; padding-bottom: 5px;">
					        		<td colspan="3"><br><span align="left" style="margin-left:4px; font-size: x-small;" id="CardSignupMsgSpan">Cannot remove payment method, beacause it has open balance for following signups.</span>
					        		</td>
					        	</tr>
								...
								<tr>
	  								...
	  								<td style="padding-bottom:3px; font-weight: bold;width: 250px;" nowrap="nowrap"><span id="CardReassignColumnLbl">Reassign</span></td>
								</tr>
					        </table>
						</div>
					        ...
					        <div style="display: table; width: 100%">
								<div style="display: table-row; width: 100%;" align="right">
									<div align="right" style="margin-top: 30px;">
					        			<span style="width: 100px;" id="updateCardInfoButtonSpan">
					        				<button id="addCardButton" class="k-button" style="font-size: small; min-width: 80px;">Add</button>
										</span>
										<span style="width: 100px; margin-left: 20px;" id="removeCardInfoButtonSpan">
											<button id="removeCardInfoButton" class="k-button" style="font-size: small; min-width: 80px;">Remove</button>
						...
						<div id="addBank" style="margin-top:10px; margin-bottom:10px; height:100px; display:none;   float: left; ">										
							...
							<div style="height:50px;">
								...
								<div class="addcarddiv">
									...
									<div><input type="text" class="k-textbox" placeholder="Check Number" name="checkNumber" id="checkNumber" value="" maxlength="8" style="width: 15.4em;" tabIndex="4"></div>
								</div>
							</div>
							...
							<div style="height:50px;">
								<div class="addcarddiv">
									...
									<div><input type="text" class="k-textbox" placeholder="Account Name" name="bankAccountName" id="bankAccountName" value="" maxlength="40" style="width: 15.4em;" tabIndex="5"></div>
								</div>
								<div class="addcarddiv">
									<div style="height:20px;">Nick Name</div>
									<div><input type="text" class="k-textbox" placeholder="Nick Name" name="bankInfoNickName" id="bankInfoNickName" value="" maxlength="30" style="width: 15.4em;" tabIndex="6"></div>
								</div>
							</div>
						...
						<div id="remove_bank_payment_method_signup_list" align="center" style="width:500px; margin-top:25px; margin-bottom:10px; display:none; background-color:#FFFFFF;"> <!-- class="k-block" -->
					        <table cellpadding="0" cellspacing="0" rules="none" style="padding-left:4px;padding-top:4px; width: 500px;" id="remove_bank_payment_method_signup_list_table">
					        	<tr align="left" style="height: 30px; padding-bottom: 5px;">
					        		<td colspan="3"><br><span align="left" style="margin-left:4px; font-size: x-small;" id="BankSignupMsgSpan">Cannot remove payment method, beacause it has open balance for following signups.</span>
					        		</td>
					        	</tr>
								<tr align="center" style="height: 30px;">
									<td colspan="3"><span class="head" style="margin-left:4px; font-size: small; text-align: center;">Signup List</span>
								...
								<tr>
	  								<td style="padding-bottom:3px;padding-left:4px; font-weight: bold; width: 100px;" nowrap="nowrap">Signup Name</td>
	  								<td style="padding-bottom:3px; font-weight: bold;width: 100px;" nowrap="nowrap">Signup Date</td>
	  								<td style="padding-bottom:3px; font-weight: bold;width: 250px;" nowrap="nowrap"><span id="BankReassignColumnLbl">Reassign</span></td>
								</tr>
					        </table>
						</div>
