		...
		<table id="afterschool_list"  style="table-layout: fixed; display:none">
			...
			<thead>
 			...
 			<tbody>
  				...
  				<tr>
  					<td><input type="radio" ${itemdetail[8]} name="afterSchoolRadio" id="afterSchoolRadio${itemdetail[0]}" value="${itemdetail[0]}"></td>
					<td>${itemdetail[1]}</td>
					<%-- <td>${itemdetail[2]}</td> --%>
					...
					<td><fmt:formatDate type="date" pattern="MM/dd/YYYY"  value="${itemdetail[6]}" /></td>
					<td><fmt:formatDate type="date" pattern="MM/dd/YYYY"  value="${itemdetail[7]}" /></td>
					<td>${itemdetail[4]}</td>
					<td>
						<input type="hidden" name="asItemDetailsType" id="asItemDetailsType_${itemdetail[0]}" value="${itemdetail[1]}">
						<input type="hidden" name="asCapacity" id="asCapacity_${itemdetail[0]}" value="${itemdetail[5]}">
						${itemdetail[5]}
					</td>
					<%-- <td>${itemdetail[6]}</td> --%>
					<%-- <td>${itemdetail[7]}</td>
