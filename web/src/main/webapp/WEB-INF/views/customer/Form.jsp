...
<spring:bind path="account.*">
 ...
 <div id="profileinfo">
	  ...
	  <label><form:input type="text" path="phoneNumber"  placeholder="Phone Number" name="phoneNumber" id="phoneNumber" value="${usInfo.formattedPhoneNumber}" /></label>
	  ...
	  <c:choose>
	    	<c:when test="${sessionScope.agentUid eq null}">
	    		 <span id="dobSpanArea" style="display : none;">		    		
	    	</c:when>
	    	<c:otherwise>
	    		 <span id="dobSpanArea" style="display : inline;">
	        </c:otherwise>  
	    </c:choose>	
	...
	<c:choose>
    	<c:when test="${sessionScope.agentUid == null}">
    		 <span id="dobSpanAreaLabel" style="display : inline;">${primaryUserDOB }</span>  	    		
    	</c:when>
    	<c:otherwise>
    		 <span id="dobSpanAreaLabel" style="display : none;">${primaryUserDOB }</span>  
        </c:otherwise>  
    </c:choose>
