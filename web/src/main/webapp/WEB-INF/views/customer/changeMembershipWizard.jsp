				  		...
				  		<div id="wizard" class="swMain">
				           ...
				           <span style="display : none;" id="adultAgeValidationLowerLimit">${adultAgeValidationLowerLimit }</span>
				            ...
				            <div style="display: none;">
								...
								<input type="hidden" id="signedUpProductsValueSpann" value="${signUpProduct.signupPrice }">								
								...
								<input type="hidden" id="signedUpPricingOption" value="${signUpProduct.signUpPricingOption }">
								
								<input type="hidden" id="signUpProductNextBillingDate" value="${signUpProduct.membersshipFeeNextBillingDate }">	
								<fmt:formatDate type="date" pattern="MM" value="${signUpProduct.membersshipFeeNextBillingDate }" var="nextBillDateMonth"/>
								<fmt:formatDate type="date" pattern="dd" value="${signUpProduct.membersshipFeeNextBillingDate }" var="nextBillDateDay"/>
								<fmt:formatDate type="date" pattern="yyyy" value="${signUpProduct.membersshipFeeNextBillingDate }" var="nextBillDateYear"/>
								<input 	style="display : none;" id="nextBillDateMonth" value="${nextBillDateMonth }"/>
								<input 	style="display : none;" id="nextBillDateDay" value="${nextBillDateDay }"/>
								<input 	style="display : none;" id="nextBillDateYear" value="${nextBillDateYear }"/>
								<%-- <fmt:formatDate type="date" pattern="yyyy/MM/dd" value="${signUpProduct.membersshipFeeNextBillingDate }" var="nextBillDateDob"/> --%>								
							...
							<div id="registerDiv" >
				            	<form:form commandName="account" method="post" action="changeMembershipRegister" id="becomeMemberForm" style="border : none; padding : 0px; margin : 0px; max-width: 100%;" autocomplete="off"
										...
										<input type="hidden" id="proratedSignupPrice" name="proratedSignupPrice" value="">
									 ...
									 <table border="0" width="100%" id="userInfoTb" class="primaryUserInfoTable">					 						 
									 	<tr>
									 		<td><h2 style="margin-top: 5px; margin-bottom : 5px;"><span id="primaryMemberTxtSpan">MEMBER 1 INFORMATION</span></h2> </td>
									 		<td>
									 	...
									 	<tr>
											<%-- <c:choose>
												<c:when test="${primaryUser != null && primaryUser.firstName != null }">
													<td><form:input cssClass="form-control" path="userLst[0].firstName" title="Please enter your First Name" name="firstName" id="firstName" maxlength="50" placeholder="First Name" value="${primaryUser.firstName}" /></td>
												</c:when>
												<c:otherwise>
											...
											<td><form:input cssClass="form-control" path="userLst[0].firstName" title="Please enter your First Name" name="firstName" id="firstName" maxlength="50" placeholder="First Name" value="${primaryUser.firstName}" /></td>							 		
									 		<td>&nbsp;</td>
									 		<td><form:input cssClass="form-control" path="userLst[0].lastName" title="Please enter your Last Name" name="lastName" id="lastName" maxlength="50" placeholder="Last Name" value="${primaryUser.lastName}"/></td>
									 		<td>&nbsp;</td>
									 	</tr>
									 	<tr>	
									 	...
									 	<fmt:formatDate type="date" pattern="MM/dd/yyyy" value="${primaryUser.dateOfBirth}" var="primaryUserDOB"/> 		
									 		<td style="padding-bottom: 8px;">
									 			<form:input  path="userLst[0].dateOfBirth"  name="dob" id="dob" maxlength="50" placeholder="Date of Birth"  style="width: 1px; height: 1px; left : -1000px; margin: 0; padding: 0;" value="${primaryUserDOB }"/>								 			
									 		...
									 		<td id="dop-er"></td>
									 		<td><form:input cssClass="form-control" path="userLst[0].formattedPhoneNumber" title="Please enter your Phone Number" name="phoneNumber" id="phoneNumber" maxlength="50" placeholder="Phone Number" value="${primaryUser.formattedPhoneNumber}"/></td>
									 		<td></td>
									 	</tr>
									 	
										<tr>		 		
									 		<td><form:input cssClass="form-control" path="userLst[0].emailAddress" readonly="true" name="email" id="email"  maxlength="50" placeholder="Email"  value="${primaryUser.emailAddress}"/></td>			 							 		
									 		<td></td>
									 		<td>
									 		<%-- <span><form:radiobutton cssClass="form-control" path="workNumber" value="Male" id="genderM" />&nbsp;Male&nbsp;<form:radiobutton cssClass="form-control" path="workNumber" value="Female" id="genderF" />&nbsp;Female</span> --%>
									 			<span >
									 				<c:choose>
														<c:when test="${primaryUser != null && primaryUser.gender != null && primaryUser.gender == 'Male'}">
															<span><span><form:radiobutton checked="checked" cssClass="form-control primary-user-gender" path="userLst[0].gender" style="width : 15px;" value="Male" id="genderM" title="Please select gender"/></span><span style="margin-left : 5px;">Male</span></span>
														...
														<c:otherwise>
															<span><span><form:radiobutton  cssClass="form-control primary-user-gender" path="userLst[0].gender" style="width : 15px;" value="Male" id="genderM" title="Please select gender"/></span><span style="margin-left : 5px;">Male</span></span>
									 						<span><span><form:radiobutton checked="checked" cssClass="form-control primary-user-gender" path="userLst[0].gender"  style="width : 15px;" value="Female" id="genderF" title="Please select gender" /></span><span style="margin-left : 5px;">Female</span></span>
														</c:otherwise>
													</c:choose>									 				
									 			</span> 
									 		</td>
									...
									<form:input style="display:none;" path="signUpProductType" id="signUpProductTypeNew" value="" />
				        	...
				        	<div id="step-4">
				        		...
				        		<form  id="addCardInfoForm" action="#">
									...
									<div class="addcarddiv" style="display : none;">
										...
										<%-- <input type="text" id="start" readonly name="startDate" style="width:150px;" value="${nextBillDateYear +'/' +nextBillDateMonth + '/'+nextBillDateDay }"> --%>
										<input type="text" id="start" readonly name="startDate" style="width:150px; display : none;" />
									</div>
						...
						<!-- <div><input type="text" class="k-textbox" placeholder="Card Number" tabIndex="2" autocomplete="off" maxlength="16" size="16" value="" onchange="handleCCTyping(this.form, event);" onkeyup="handleCCTyping(this.form, event);" id="cardNumber" name="cardNumber" placeholder="Credit Card Number" style="width: 230px;"></div> -->
											...
											<div style="height:50px;">
												...
												<div id="savecardcheckbox" class="addcarddiv" style="width:150px">
													<div><input type="checkbox" class="SaveCard" name="SaveCard" id="SaveCard">&nbsp;&nbsp;Save Payment Method</div>
									...
									<div id="addBank" style="margin-top:10px; margin-bottom:10px; height:44px; display:none;   float: left; ">										
											...
											<div style="height:50px;">
												...
												<div id="nickname" class="addcarddiv" >
													<div style="height:20px;">Nick Name</div>
													<div><input type="text" class="k-textbox" placeholder="Nick Name" name="nickName" id="nickName1" value=""></div> 
												</div>
											</div>										
									</div><br />
									</form>
																		...
																		<table style="/* float: left; margin-left: 5px; */"
																			...
																			<tbody style="min-height: 300px;">
																				...
																				<tr>
																					...
																					<!-- <td id="sumTotalPriceTd"></td> -->
																					<td style="border-bottom: 1px solid #ddd; padding-bottom: 5px;" align="right"><span>$</span><span id="sumTotalPriceTd"></span><input type="hidden" id="totalDiscountHiddenInput"></td>
																				</tr>
																				
																				<tr style="display:none;" id="sumChangePriceTr">
																					<td><span><b>Change Price(Current Month)</b></span></td>
																					<td align="right"><span>$</span><span id="sumChangePriceTd"></span></td>
																				</tr>
																				...
																				<tr style="display:none;" id="sumProRatePriceTr">
																					...
																					<td align="right"><span>$</span><span id="sumProRatePriceTd"></span></td>
																				</tr>
																				<tr id="sumFinalAmountTr">
																					<td><span><b>Final Amount</b></span></td>
																					<!-- <td id="sumTotalPriceTd"></td> -->
...
<script id="select-family-member-Box" type="text/x-kendo-template">
    <p class="add-family-member-p">
		<div>
			...
			<c:if test="${fn:length(selectKidsInfo) gt 0}">
			...
			<div>
				 <table cellpadding="5px" border="1" id="selectKidsInfoTable" style="border-collapse: collapse;"> 
					...
					<c:forEach var="kid" items="${selectKidsInfo}" varStatus="count">
						<c:if test="${ kid != null}">				
 							<tr> 
...
$(document).ready(function(){
	...
	console.log("  changemembershipWizard onload 1 ");
...
eventer(messageEvent,function(e) {
	...
	console.log(" changeMembershipWizard onload 2 " );

	proceedToChangeMembershipSignup();
	
	console.log(" changeMembershipWizard onload 3 " );
	
	if(urlPromoItemDetailId != null && urlPromoItemDetailId != undefined && urlPromoItemDetailId != ''){
		proceedToRegisterChangeMembership();
	}

	console.log(" changeMembershipWizard onload 4 " );
...
function getSecondUserInfoData(userNo){
	...
	secondUserInfoTableHtml += '<td><input type="text" class="form-control"  title="Please enter yout First Name" name="userLst['+userNo+'].firstName" id="secFirstName" maxlength="50" placeholder="First Name"  value="${secUser.firstName}"/></td>';
	secondUserInfoTableHtml += '<td>&nbsp;</td>';
	secondUserInfoTableHtml += '<td><input type="text" class="form-control"  title="Please enter yout Last Name" name="userLst['+userNo+'].lastName" id="secLastName" maxlength="50" placeholder="Last Name" value="${secUser.lastName}"/></td>';
	secondUserInfoTableHtml += '<td>&nbsp;</td>';
	secondUserInfoTableHtml += '</tr>';
	
	/* secondUserInfoTableHtml += '<tr>';	
	secondUserInfoTableHtml += '<fmt:formatDate type="date" pattern="MM/dd/yyyy" value="${secUser.dateOfBirth}" var="secondaryUserDOB"/>';
	secondUserInfoTableHtml += '<td style="padding-bottom: 8px;"><input type="text" class="dob-class"  title="Please enter your Date of Birth" name="userLst['+userNo+'].dateOfBirth" id="secDOB" maxlength="50" placeholder="Date of Birth"  style="width: 205px; height: 30px; margin: 0; padding: 0;" value="${secondaryUserDOB}"/></td>';
	 */
	secondUserInfoTableHtml += '<tr>';
	secondUserInfoTableHtml += '<fmt:formatDate type="date" pattern="MM/dd/yyyy" value="${secUser.dateOfBirth}" var="secondaryUserDOB"/>';
	secondUserInfoTableHtml += '<td style="padding-bottom: 8px;"><input type="text" class="dob-class"  title="Please enter your Date of Birth" name="userLst['+userNo+'].dateOfBirth" id="secDOB" maxlength="50" placeholder="Date of Birth"  style="width: 1px; height: 1px; left : -1000px; margin: 0; padding: 0; " value="${secondaryUserDOB}"/> <br />';
	...
	secondUserInfoTableHtml += '<td><input type="text" class="form-control phone-number" title="Please enter your Phone Number" name="userLst['+userNo+'].formattedPhoneNumber" id="secPhoneNumber" maxlength="50" placeholder="Phone Number" value="${secUser.formattedPhoneNumber}"/></td>';
	secondUserInfoTableHtml += '<td>&nbsp;</td>';
	secondUserInfoTableHtml += '</tr>';		
	
	secondUserInfoTableHtml += '<tr>';
	secondUserInfoTableHtml += '<td><input type="text" class="form-control" readonly name="userLst['+userNo+'].emailAddress" id="secEmail"  maxlength="50" placeholder="Email"  value="${secUser.emailAddress}"/></td>'; 
	/*secondUserInfoTableHtml += '<td><input type="text" class="form-control"  name="userLst['+userNo+'].emailAddress" id="secEmail"  maxlength="50" placeholder="Email"  value="Test' + Math.floor((Math.random()*1000000000000)+1) +'@gmail.com" style="display:none;"/></td>';*/
	secondUserInfoTableHtml += '<td id="dop-er"></td>';

	secondUserInfoTableHtml += '<td>';	
	if("${secUser.gender}" == "Male") {
		secondUserInfoTableHtml += '<span>';
		secondUserInfoTableHtml += '<span><span><input id="secGenderM" checked="checked" name="userLst['+userNo+'].gender" class="form-control" style="width: 15px;" type="radio" value="Male"></span><span style="margin-left : 5px;">Male</span></span>';
    	...
    	secondUserInfoTableHtml += '<span><span><input id="secGenderF" checked="checked" name="userLst['+userNo+'].gender" class="form-control" style="width : 15px;" type="radio" value="Female"></span><span style="margin-left : 5px;">Female</span></span>';
    	secondUserInfoTableHtml += '</span>';
    }
	secondUserInfoTableHtml += '</td>';	
	secondUserInfoTableHtml += '<td>&nbsp;</td>';
...
function getYouthUserInfoData(userNo){
	...
	secondUserInfoTableHtml += '<td><input type="text" class="form-control email-check" readonly name="userLst['+userNo+'].emailAddress" id="secEmail"  maxlength="50" placeholder="Email" value="${secUser.emailAddress}"/></td>'; 
	secondUserInfoTableHtml += '<td id="dop-er"></td>';
	secondUserInfoTableHtml += '<td><input type="text" class="form-control phone-number" title="Please enter your Phone Number" name="userLst['+userNo+'].formattedPhoneNumber" id="secPhoneNumber" maxlength="50" placeholder="Phone Number" value="${secUser.formattedPhoneNumber}"/></td>';
	secondUserInfoTableHtml += '<td>&nbsp;</td>';
	secondUserInfoTableHtml += '</tr>';
	
	secondUserInfoTableHtml += '<c:if test="${!pageContext.request.userPrincipal.isAuthenticated() && sessionScope.agentUid == null}">';	
...
function getThirdUserInfoData(userNo){
	var secondUserInfoTableHtml = '';
	secondUserInfoTableHtml += '<tr>';
	secondUserInfoTableHtml += '<td><input type="text" class="form-control" title="Please enter yout First Name" name="userLst['+userNo+'].firstName" id="thirdFirstName" maxlength="50" placeholder="First Name" value="${thirdUser.firstName}" /></td>';
	secondUserInfoTableHtml += '<td>&nbsp;</td>';
	secondUserInfoTableHtml += '<td><input type="text" class="form-control" title="Please enter yout Last Name" name="userLst['+userNo+'].lastName" id="thirdLastName" maxlength="50" placeholder="Last Name" value="${thirdUser.lastName}"/></td>';
	secondUserInfoTableHtml += '<td>&nbsp;</td>';
	secondUserInfoTableHtml += '</tr>';
	
	secondUserInfoTableHtml += '<tr>';
	/* secondUserInfoTableHtml += '<fmt:formatDate type="date" pattern="MM/dd/yyyy" value="${thirdUser.dateOfBirth}" var="thirdUserDOB"/>';
	secondUserInfoTableHtml += '<td style="padding-bottom: 8px;"><input type="text" class="dob-class"  title="Please enter your Date of Birth" name="userLst['+userNo+'].dateOfBirth" id="thirdDOB" maxlength="50" placeholder="Date of Birth"  style="width: 205px; height: 30px; margin: 0; padding: 0;" value="${thirdUserDOB}"/></td>'; */
	secondUserInfoTableHtml += '<fmt:formatDate type="date" pattern="MM/dd/yyyy" value="${thirdUser.dateOfBirth}" var="thirdUserDOB"/>';
	secondUserInfoTableHtml += '<td style="padding-bottom: 8px;"><input type="text" class="dob-class"  title="Please enter your Date of Birth" name="userLst['+userNo+'].dateOfBirth" id="thirdDOB" maxlength="50" placeholder="Date of Birth"  style="width: 1px; height: 1px; left : -1000px; margin: 0; padding: 0;" value="${thirdUserDOB}"/><br />';
	secondUserInfoTableHtml += getDOBHtml("thirdDobYearForm",  "thirdDobMonthForm", "thirdDobDateForm");
	secondUserInfoTableHtml += '</td>';
	secondUserInfoTableHtml += '<td id="dop-er"></td>';
	secondUserInfoTableHtml += '<td><input type="text" class="form-control phone-number" title="Please enter your Phone Number" name="userLst['+userNo+'].formattedPhoneNumber" id="thirdPhoneNumber" maxlength="50" placeholder="Phone Number" value="${thirdUser.formattedPhoneNumber}"/></td>';
	secondUserInfoTableHtml += '<td>&nbsp;</td>';
	secondUserInfoTableHtml += '</tr>';	
	
	secondUserInfoTableHtml += '<tr>';
	secondUserInfoTableHtml += '<td><input type="text" class="form-control" readonly name="userLst['+userNo+'].emailAddress" id="thirdEmail"  maxlength="50" placeholder="Email" value="${thirdUser.emailAddress}" /></td>';
	/* secondUserInfoTableHtml += '<td><input type="text" class="form-control"  name="userLst['+userNo+'].emailAddress" id="thirdEmail"  maxlength="50" placeholder="Email" value="Test' + Math.floor((Math.random()*1000000000000)+1) +'@gmail.com" style="display:none;" /></td>'; */
	secondUserInfoTableHtml += '<td id="dop-er"></td>';

	secondUserInfoTableHtml += '<td>';
	if("${thirdUser.gender}" == "Male") {
		secondUserInfoTableHtml += '<span>';
		secondUserInfoTableHtml += '<span><span><input id="thirdGenderM" name="userLst['+userNo+'].gender" checked="checked" class="form-control" style="width: 15px;" type="radio" value="Male"></span><span style="margin-left : 5px;">Male</span></span>';
		...
		secondUserInfoTableHtml += '<span><span><input id="thirdGenderF" name="userLst['+userNo+'].gender" checked="checked" class="form-control" style="width : 15px;" type="radio" value="Female"></span><span style="margin-left : 5px;">Female</span></span>';
		secondUserInfoTableHtml += '</span>';
	}
	secondUserInfoTableHtml += '</td>';	
...
function getKidsInfoHtml(kidNo){
	...
	<c:if test="${fn:length(kidsInfo) gt 0}">
		<c:forEach var="kid" items="${kidsInfo}" varStatus="count">
			<c:if test="${ kid != null && count.index == 0}">			
				...
				kidsInfoTableHtml += '<tr>';
				kidsInfoTableHtml += '<td><input type="text" class="form-control firstName personFirstName" title="Please enter yout First Name" name="userLst['+kidNo+'].firstName" id="firstName" maxlength="50" placeholder="First Name" value="${kid.firstName }" /></td>';
				kidsInfoTableHtml += '<td>&nbsp;</td>';
				kidsInfoTableHtml += '<td><input type="text" class="form-control lastName personLastName" title="Please enter yout Last Name" name="userLst['+kidNo+'].lastName" id="lastName" maxlength="50" placeholder="Last Name" value="${kid.lastName }"/></td>';
				kidsInfoTableHtml += '<td>&nbsp;</td>';
				kidsInfoTableHtml += '</tr>';
				
				kidsInfoTableHtml += '<tr>';
				kidsInfoTableHtml += '<fmt:formatDate type="date" pattern="MM/dd/yyyy" value="${kid.dateOfBirth }" var="kidUserDOB"/>';
				//kidsInfoTableHtml += '<td style="padding-bottom: 8px;"><input type="text" class="form-control dob-class dateOfBirth dateOfBirthValidation"  title="Please enter your Date of Birth" name="userLst['+kidNo+'].dateOfBirth"  maxlength="50" placeholder="Date of Birth"  style="width: 205px; height: 30px; margin: 0; padding: 0;" value="${kidUserDOB }"/></td>';
				kidsInfoTableHtml += '<td style="padding-bottom: 8px;"><input type="text" class="form-control dob-class dateOfBirth dateOfBirthValidation"  title="Please enter your Date of Birth" name="userLst['+kidNo+'].dateOfBirth"  maxlength="50" placeholder="Date of Birth" id="firstKidDOBInp"  style="width: 1px; height: 1px; left : -1000px; margin: 0; padding: 0;" value="${kidUserDOB }" /> <br />';
				...
				if("${kid.gender}" == "Male") {
					...
					kidsInfoTableHtml += '<span><span><input  name="userLst['+kidNo+'].gender" checked="checked" class="form-control gender" style="width: 15px;" type="radio" value="Male"></span><span style="margin-left : 5px;">Male</span></span>';
					...
					kidsInfoTableHtml += '<span><span><input  name="userLst['+kidNo+'].gender" checked="checked" class="form-control gender" style="width : 15px;" type="radio" value="Female"></span><span style="margin-left : 5px;">Female</span></span>';
					kidsInfoTableHtml += '</span>';
				}
				kidsInfoTableHtml += '</td>';	
	...
	/* <c:if test="${ kid != null && count.index gt 1}">
				var dob = '<fmt:formatDate type="date" pattern="MM/dd/yyyy" value="${kid.dateOfBirth }" var="secKidUserDOB"/>';
				populateSecondaryKidsInfoWithDataByDefault("${kid.firstName }", "${kid.lastName }", "${kid.gender }", "${secKidUserDOB }");
	</c:if> */
	</c:forEach>	
</c:if>
<c:if test="${fn:length(kidsInfo) eq 0}">
	var kidsInfoTableHtml = '';
	kidsInfoTableHtml += '<tr>';
	kidsInfoTableHtml += '<td colspan="4">';
	kidsInfoTableHtml += '<table border="0" width="101%" class="firstKidInfoForm">';
	kidsInfoTableHtml += '<tr>';
	kidsInfoTableHtml += '<td><input type="text" class="form-control firstName personFirstName" title="Please enter yout First Name" name="userLst['+kidNo+'].firstName" id="firstName" maxlength="50" placeholder="First Name" value="" /></td>';
	kidsInfoTableHtml += '<td>&nbsp;</td>';
	kidsInfoTableHtml += '<td><input type="text" class="form-control lastName personLastName" title="Please enter yout Last Name" name="userLst['+kidNo+'].lastName" id="lastName" maxlength="50" placeholder="Last Name" value=""/></td>';
	kidsInfoTableHtml += '<td>&nbsp;</td>';
	kidsInfoTableHtml += '</tr>';
	
	kidsInfoTableHtml += '<tr>';
	
	//kidsInfoTableHtml += '<td style="padding-bottom: 8px;"><input type="text" class="form-control dob-class dateOfBirth dateOfBirthValidation"  title="Please enter your Date of Birth" name="userLst['+kidNo+'].dateOfBirth"  maxlength="50" placeholder="Date of Birth"  style="width: 205px; height: 30px; margin: 0; padding: 0;" value=""/></td>';
	kidsInfoTableHtml += '<td style="padding-bottom: 8px;"><input type="text" class="form-control dob-class dateOfBirth dateOfBirthValidation"  title="Please enter your Date of Birth" name="userLst['+kidNo+'].dateOfBirth"  maxlength="50" placeholder="Date of Birth" id="firstKidDOBInp"  style="width: 1px; height: 1px; left : -1000px; margin: 0; padding: 0;" /> <br />';
	kidsInfoTableHtml += getDOBHtml("firstKidDobYearForm",  "firstKidDobMonthForm", "firstKidDobDayForm");
	kidsInfoTableHtml += '</td>';
	kidsInfoTableHtml += '<td id="dop-er"></td>';
...
function populateSecondaryKidsInfoWithDataByDefault(){
	<c:if test="${fn:length(kidsInfo) gt 0}">
		<c:forEach var="kid" items="${kidsInfo}" varStatus="count">
			<c:if test="${ kid != null && count.index gt 0}">	
				var dob = '<fmt:formatDate type="date" pattern="MM/dd/yyyy" value="${kid.dateOfBirth }" var="secKidUserDOB"/>';
				var dobMonth = '<fmt:formatDate type="date" pattern="MM" value="${kid.dateOfBirth }" var="secKidUserDOBMonth"/>';
				var dobDate = '<fmt:formatDate type="date" pattern="dd" value="${kid.dateOfBirth }" var="secKidUserDOBDate"/>';
				var dobYear = '<fmt:formatDate type="date" pattern="yyyy" value="${kid.dateOfBirth }" var="secKidUserDOBYear"/>';
				var count = secKidCount;		
				var kidFirstName = "${kid.firstName }";
				var kidLastName =  "${kid.lastName }";
				var kidDob =  "${secKidUserDOB }";
				var kidDobMonth = "${secKidUserDOBMonth}";
				var kidDobDate = "${secKidUserDOBDate}";
				var kidDobYear = "${secKidUserDOBYear}";
				var kidGender = "${kid.gender }";
				...
				kidsInfoTableHtml += '<td style="padding-bottom: 8px;"><input type="text" class="form-control dob-class dateOfBirth dateOfBirthValidation"  title="Please enter your Date of Birth" name="userLst['+count+'].dateOfBirth"  maxlength="50" placeholder="Date of Birth"  style="width: 1px; height: 1px; left : -1000px; margin: 0; padding: 0;" value="'+kidDob+'"/><br />';
				kidsInfoTableHtml += getDOBHtmlbyClass("kidDobYearForm",  "kidDobMonthForm", "kidDobDateForm", kidDobMonth, kidDobDate, kidDobYear);
				kidsInfoTableHtml += '</td>';
				kidsInfoTableHtml += '<td id="dop-er"></td>';
				...
				kidsInfoTableHtml += '<tr style="display : none;">';
				kidsInfoTableHtml += '<td><input style="display:none;" name="userLst['+count+'].isAdult" value="false"/><input style="display:none;" name="userLst['+count+'].membershipAgeCategory" value="Kid"/></td>';
				kidsInfoTableHtml += '<td>&nbsp;</td>';	
...
function getKidsInfoHeader(){
	...
	kidsInfoTableHtml += '<c:forEach var="kidUser" items="${selectKidsInfo}" varStatus="count">';
...
/* function getSecondaryKidInfoHeader() {
	...
	kidsInfoTableHtml += '<c:if test="${ kidUser != null}">';
	kidsInfoTableHtml += '<c:set var="dobkidUserVar" ><fmt:formatDate type="date" pattern="MM/dd/yyyy" value="${kidUser.dateOfBirth }" /></c:set>';
	kidsInfoTableHtml += '<option value="${kidUser.firstName }_${kidUser.lastName }_${dobkidUserVar }_${kidUser.gender }_${kidUser.contactId }">${kidUser.firstName } ${kidUser.lastName }</option>';
	kidsInfoTableHtml += '</c:if>';		
	kidsInfoTableHtml += '</c:forEach>';
	kidsInfoTableHtml += '<option value="Other">New Member</option>';
	kidsInfoTableHtml += '</select>';
...
function populatePrimarySecondaryThirdYouthMember(){
	populatePrimaryMemberDOB("${primaryUserDOB}");
	populateSecondaryMemberDOB("${secondaryUserDOB}");
	populateYouthMemberDOB("${secondaryUserDOB}");
	populateThirdMemberDOB("${thirdUserDOB}");
	populateFirstKidDOB("${kidUserDOB}");
	/* populateMemberDOB("${primaryUserDOB}", "dobMonthForm", "dobDateForm", "dobYearForm");
	populateMemberDOB("${secondaryUserDOB}", "secDobMonthForm", "secDobDateForm", "secDobYearForm");
	populateMemberDOB("${secondaryUserDOB}", "youthDobMonthForm", "youthDobDateForm", "youthDobYearForm");
	populateMemberDOB("${thirdUserDOB}", "thirdDobMonthForm", "thirdDobDateForm", "thirdDobYearForm"); */
}

function populatePrimaryMemberDOB(dob){	
...
function populateSecondaryMemberDOB(adultDob){	
...
function populateThirdMemberDOB(adultDob){	
...
function populateYouthMemberDOB(adultDob){	
...
function populateFirstKidDOB(fkidDob){
	var dobMonthForm = $('#becomeMemberForm').find("#firstKidDobMonthForm").data("kendoDropDownList");
	var dobDateForm = $('#becomeMemberForm').find("#firstKidDobDayForm").data("kendoDropDownList");
	var dobYearForm = $('#becomeMemberForm').find("#firstKidDobYearForm").data("kendoDropDownList");    
	//10/14/1984
