				...
				<!-- Smart Wizard -->
				  		...
				  		<div id="wizard" class="swMain">
							...
							<div style="display: none;">
								<input type="hidden" id="primaryContactFName" value="${primaryUser.personFirstName }">
								<input type="hidden" id="primaryContactLName" value="${primaryUser.personLastName }">
								<input type="hidden" id="signupProductId" value="${signUpProduct.itemDetails.id }">
							...
							<div id="step-2">
							<input style="display:none;" path="itemDetailsId" id="signedUplocationId" value="${signUpProduct.location.locationId }" />
			              ...
			              class="bootstrap-frm cmxform" >			        
								...
								<form:input style="display:none;" path="itemDetailsId" id="itemDetailsId" value="${signUpProduct.itemDetails.id }" />
