      ...
      <c:when test="${status.count<='4'}">
							 ...
							 <tr style="outline: thin solid;padding-left:3px;">
								...
								<td style="color: red;"><fmt:formatDate
										...
										value="${program.programStartDate}" /></td>
								<td style="color: red; padding-left:2px;" align="left"><a onclick="add_member();" href="#" id="addmemberLink">${program.itemDetails.itemName}</a></td>
...
<!-- <a style="margin-left:190px;" href="viewAllPrograms" target="_self" id="addmemberLink" >view more</a>  -->
	  ...
	  <c:otherwise></c:otherwise>
				...
				<a style="margin-left:4px;" href="viewAllPrograms" target="_self" id="addmemberLink" >view more</a> 
</div>
					...
					<tbody>
						...
						<c:forEach var="otherPrograms" items="${otherPrograms}">
							...
							<tr>
								...
								<td style="color: red;">${otherPrograms.programs}</td>
							<td style="color: red;">${otherPrograms.defaultPromoCode}</td>
