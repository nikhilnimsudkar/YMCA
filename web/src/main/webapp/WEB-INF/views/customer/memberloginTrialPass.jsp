						  			  ...
						  			  for(var i = 0; i<accData.length; i++){        
						  				   ...
						  				   if(dataArr != null && dataArr.userLst.length > 0){
							  				   for(var k = 0; k<dataArr.userLst.length; k++){        
									  				...
									  				$('#firstName').attr("value", userArr.firstName);
								  					$('#lastName').attr("value", userArr.lastName);										    			
								  					$('#phoneNumber').attr("value", userArr.formattedPhoneNumber);
								  					$('#email').attr("value", userArr.emailAddress); 
								  					$('#dob').attr("value",formattedDate);
								  					//$('#')
								  					 $('#firstNameTd').html(userArr.firstName);
						  					$('#lastNameTd').html(userArr.lastName);
						  					$('#dobTd').html(birthDate);
						  					$('#phoneNumberTd').html(userArr.formattedPhoneNumber);
						  					$('#emailTd').html(userArr.emailAddress);
						  					$('#genderTd').html(userArr.gender);
								  			$('#dobTd').html(formattedDate);
